...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 662.0, 221.0, 100.0, 102.040816326530617 ],
					"pic" : "clipart336358.png"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 662.0, 331.0, 196.0, 60.0 ],
					"text" : "Don't use [send] and [receive]; it is better to connect objects directly. It is faster and will make your patches easier to understand."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 363.0, 325.0, 60.0, 24.0 ],
					"text" : "r trigger",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 363.0, 285.0, 62.0, 24.0 ],
					"text" : "s trigger",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 477.0, 362.0, 143.0, 29.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 363.0, 150.0, 43.0, 43.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 363.0, 353.0, 23.0, 24.0 ],
					"text" : "t i",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 363.0, 243.500000000000028, 76.0, 23.0 ],
					"text" : "uzi 100000"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 363.0, 207.5, 133.0, 23.0 ],
					"text" : "t b b"
				}
...
,
					"patching_rect" : [ 477.0, 286.0, 71.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 181.0, 362.0, 143.0, 29.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 67.0, 282.0, 42.0, 24.0 ],
					"text" : "t i",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "bang", "bang", "int" ],
					"patching_rect" : [ 67.0, 243.500000000000028, 76.0, 23.0 ],
					"text" : "uzi 100000"
				}
...
,
					"patching_rect" : [ 181.0, 284.32307692307694, 69.0, 23.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"fontsize" : 11.595186999999999,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 76.0, 537.0, 95.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 28.0, 74.366022099447491, 145.0, 20.0 ],
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 401.0, 274.0, 538.5, 274.0 ],
					"source" : [ "obj-22", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 105.0, 275.5, 240.5, 275.5 ],
					"source" : [ "obj-82", 1 ]
				}
