...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 125.0, 918.0, 50.5, 22.0 ],
					"text" : "key"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 20.0, 964.0, 809.0, 46.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 20.0, 918.0, 89.0, 22.0 ],
					"text" : "loadmess set 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 20.0, 1045.0, 67.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 810.0, 1050.0, 51.0, 22.0 ],
					"text" : "pcontrol"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 745.0, 241.0, 39.0, 39.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 226.876823073358537, 389.427610562768223, 38.123176926641463, 38.123176926641463 ],
					"prototypename" : "tiny"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 745.0, 306.0, 39.0, 32.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 537.0, 348.0, 420.0, 35.0 ],
					"text" : "set \"Paradigms are not meant to be mutually exclusive; a single program can feature multiple paradigms!\""
				}

			}
, 			{
				"box" : 				{
					"fontsize" : 17.767788463825717,
					"id" : "obj-8",
					"maxclass" : "comment",
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 537.0, 399.0, 178.0, 26.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 267.0, 384.989199026088954, 474.0, 26.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 383.0, 201.0, 261.0, 19.0 ],
					"presentation" : 1,
					"presentation_linecount" : 3,
					"presentation_rect" : [ 810.0, 427.0, 122.0, 40.0 ],
					"text" : "Programming Paradigms - Loyola Marymouth University",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 383.0, 234.116022099447491, 295.0, 30.0 ],
					"text" : ";\rmax launchbrowser https://cs.lmu.edu/~ray/notes/paradigms/"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 170.0, 204.116022099447491, 161.0, 275.0 ],
					"presentation" : 1,
					"presentation_linecount" : 19,
					"presentation_rect" : [ 225.0, 92.366022099447491, 121.0, 275.0 ],
					"text" : "Imperative:\nDeclarative:\nStructured:\nProcedural:\nFunctional:\nFunction-Level:\nObject-Oriented:\n\nPrototype-based:\nEvent-Driven:\nFlow-Driven:\n\nLogic (Rule-based):\n\nConstraint:\n\nAspect-Oriented:\nReflective:\nArray:\n"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ -12.0, 79.0, 58.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ -12.0, 115.0, 63.0, 22.0 ],
					"text" : "metro 666"
				}
